<footer id="footer" class="relative footer">
            <div class="gold-book">
                <h4 class="mt-2 ">Laissez un avis sur le site, cela nous permettera de l’améliorer</h4>
                <form class="flex" action="accueil.html" method="post">
                    <textarea class="solid-shadow font-normal" name="gold-book__text" cols="70" rows="10" placeholder="Votre avis sur le site..."></textarea>
                    <div class="btn-area mt-2 flex">
                        <button class="cancel-btn font-normal" type="reset" value="cancel">Annuler</button>
                        <button class="submit-btn mt-1 font-normal btn-hover__effect" type="submit" value="send">Envoyer      </button>
                    </div>
                </form>
