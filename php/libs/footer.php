<footer id="footer" class="relative footer">
            <div class="gold-book">
                <h3 class="mt-2 ">Laissez un avis sur le site, cela nous permettera de l’améliorer</h3>
                <form class="flex" action="accueil.php" method="post">
            ...
            <div class="newsletter">
                <h3 class="mt-3 relative">S’inscrire aux <span>newsletter</span> pour rester informé
