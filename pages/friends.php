...
<body id="les_amis">
    <div class="page-wrapper">
        ...
        <!-- main  -->
            <div class="friends-container mail">
                <h1 class="h2-section">Les Amis en quelques mots...</h1>
                <h5 class="h4-medium">Les “Amis de l’Athénée Royal d’Uccle 1” </h4>
                <p class="h5-medium">L’Association <strong class="quote">« Les Amis de l’Athénée Royal  d’Uccle 1 »</strong> a été créée en 1932</p>
                <p>
                ...
                <a class="btn--spoiler mt2">Lire la suite</a>
            </div>
        <!-- footer  -->
